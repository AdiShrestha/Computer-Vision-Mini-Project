...
| Masking Strategy | Full 13-CH AUC-ROC | Top Contributing Channels | Ranking Invariance |
|---|---|---|---|
| **Zero Masking** | 0.6786 | CH-01, CH-05, CH-02 | Verified |
| **Mean Imputation** | 0.6786 | CH-01, CH-05, CH-02 | Verified |
| **Gaussian Noise** | 0.6786 | CH-01, CH-05, CH-02 | Verified |

*Hyperparameter Sweeps:*
- **Score-C $\alpha$:** $\alpha \in \{0.0, 0.25, 0.50, 0.75, 1.00\}$ yields AUC-ROC values of $0.6522, 0.6654, 0.6786, 0.6898, 0.7010$. Chosen $\alpha=0.50$ balances reconstruction and embedding features.
- **EMA Span:** $\text{span} \in \{3, 5, 7, 10\}$ yields AUC-ROC values of $0.6766, 0.6786, 0.6766, 0.6736$. Chosen $\text{span}=5$ maximizes noise reduction.
