"""Landsat 8/9 acquisition module using Google Earth Engine API."""
import os
...
def acquire(lake_id: str, start_date: str, end_date: str,
    ...
    """Download Landsat 8/9 surface reflectance and QA pixel bands.
    ...
    try:
        ...
        lake_dir = os.path.join(output_dir, 'landsat', lake_id)
