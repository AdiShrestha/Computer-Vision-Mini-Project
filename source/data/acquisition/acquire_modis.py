"""MODIS LST acquisition module using Google Earth Engine API."""
import os
...
def acquire(lake_id: str, start_date: str, end_date: str,
    ...
    """Extract MODIS Land Surface Temperature (MOD11A1) at lake centroid.
    ...
    try:
        ...
        lake_dir = os.path.join(output_dir, 'modis', lake_id)
