"""Sentinel-1 GRD acquisition module using Google Earth Engine API."""
import os
import time
...
def acquire(lake_id: str, start_date: str, end_date: str,
    ...
    """Download Sentinel-1 GRD SAR scenes for a lake bounding box.

    Args:
        lake_id: Target lake ID (e.g., 'SGL-001').
    ...
    try:
        ...
        lake_dir = os.path.join(output_dir, 'sentinel1', lake_id)
        os.makedirs(lake_dir, exist_ok=True)

        # For dry-run/scaffolding test: query scene info and record metadata
